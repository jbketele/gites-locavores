...
var map = L.map('map').setView([14.6367927, -61.0158269], 10);

L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
}).addTo(map);

var marker1 = L.marker([14.468281, -60.9214796]).addTo(map);
marker1.bindPopup("<b>Le Refuge des Alizés</b><br>M. Félix");


var marker2 = L.marker([14.6776144, -60.939021]).addTo(map);
marker2.bindPopup("<b>La Refuge des Manguiers</b><br>T. Charpentier");
var marker3 = L.marker([14.6027962, -61.0676724]).addTo(map);
marker3.bindPopup("<b>Le Villa des Palmiers</b><br>S. Joseph");
