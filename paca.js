...
var map = L.map('map').setView([44.06841278076172, 5.99199104309082], 8);

L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
}).addTo(map);

var marker1 = L.marker([43.8379283, 5.9839867]).addTo(map);
marker1.bindPopup("<b>La Maison de Lavande</b><br>J.L Dupont");


var marker2 = L.marker([43.78847885131836, 4.830077648162842]).addTo(map);
marker2.bindPopup("<b>Le Mas des Oliviers</b><br>S. Leroy");
var marker3 = L.marker([43.2140359, 5.5396318]).addTo(map);
marker3.bindPopup("<b>Villa Méditerrannée</b><br>C. Dubois");
