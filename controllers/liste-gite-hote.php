<?php
require_once '../models/ajout_gite.php'; // Incluez le fichier contenant votre modèle de gîte
...
$gites = Gites::getGitesByUserId($userId);

// Incluez la vue HTML pour afficher la liste des gîtes par utilisateur
include_once '../views/liste-gite-hote.php';
?>
